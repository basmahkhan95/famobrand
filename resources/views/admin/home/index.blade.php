@extends('admin.layouts.auth', ['Title' => 'Dashboard'])
                                                                    ...
                                                                    <div class="media">
                                                                        <div class="media-body align-self-center">
                                                                            <p class="m-0">Total Domain
                                                                                Searches<br><span>{{ $TotalDomainSearch }}</span>
                                                                            </p>
                                                                        </div>
                                                                        <div class="align-self-center">
                                                                            <i class="fa fa-globe"
