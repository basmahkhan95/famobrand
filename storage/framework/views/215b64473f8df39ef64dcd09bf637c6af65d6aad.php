...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <a href="login.html" class="login back"><i class="fa fa-long-arrow-left"></i>back to
                                        Home</a>
                                </div>
                            </form>
                        </div>
...
<?php echo $__env->make('admin.layouts.guest', ['Title' => 'Login'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/famo_brand/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>