                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-7 col-12 wow fadeInRight" data-wow-duration="1.5s" data-wow-delay="300ms">
                            <div class="inner-ban-right">
                                <img src="<?php echo e(asset('user/images/logo-ban.png')); ?>" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 col-12 d-flex">
                    <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.3s">
                        <div class="work-img">
                            <img src="<?php echo e(asset('user/images/work-1.jpg')); ?>" class="hvr-icon">
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-12 d-flex">
                    <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.6s">
                        <div class="work-img">
                            <img src="<?php echo e(asset('user/images/work-2.jpg')); ?>" class="hvr-icon">
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 offset-md-0 offset-sm-3 col-12 d-flex">
                    <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.9s">
                        <div class="work-img">
                            <img src="<?php echo e(asset('user/images/work-3.jpg')); ?>" class="hvr-icon">
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-12 d-flex">
                    <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.3s">
                        <div class="work-img">
                            <img src="<?php echo e(asset('user/images/work-4.jpg')); ?>" class="hvr-icon">
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-12 d-flex">
                    <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.6s">
                        <div class="work-img">
                            <img src="<?php echo e(asset('user/images/work-5.jpg')); ?>" class="hvr-icon">
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 offset-md-0 offset-sm-3 col-12 d-flex">
                    <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.9s">
                        <div class="work-img">
                            <img src="<?php echo e(asset('user/images/work-6.jpg')); ?>" class="hvr-icon">
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', ['Title' => 'Logo Design'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev61onlinetesti/public_html/famo_brand/resources/views/logo-design.blade.php ENDPATH**/ ?>