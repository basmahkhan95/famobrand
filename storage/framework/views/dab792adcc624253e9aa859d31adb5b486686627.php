...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('user/css/datatables.min.css')); ?>">
...
<script src="<?php echo e(asset('user/js/datatables.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('user/js/datatable-basic.js')); ?>" type="text/javascript"></script>
...
<?php /**PATH /home/dev61onlinetesti/public_html/famo_brand/resources/views/layouts/app.blade.php ENDPATH**/ ?>