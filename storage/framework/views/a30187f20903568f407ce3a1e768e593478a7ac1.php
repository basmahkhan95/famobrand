...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?php echo e(asset('admin/app-assets/vendors/css/tables/datatable/datatables.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('admin/app-assets/vendors/css/extensions/sweetalert.css')); ?>">
...
<script src="<?php echo e(asset('admin/app-assets/vendors/js/extensions/sweetalert.min.js')); ?>" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    function getUnreadChatMessagesCount(){
        $.ajax({
            url: 'https://dev28.onlinetestingserver.com/soachatcentralizedWeb/api/user/get-unread-messages-count/3e509ed778094424bebf8fc540f6e72a/<?php echo e('admin-'.Auth::id()); ?>',
    ...
    $(document).ready(function () {
        ...
        const adminNotificationChannel = "<?php echo e('famo_brands_database_admin_notification.'.auth()->id()); ?>";
...
<?php /**PATH /home/dev61onlinetesti/public_html/famo_brand/resources/views/admin/layouts/auth.blade.php ENDPATH**/ ?>