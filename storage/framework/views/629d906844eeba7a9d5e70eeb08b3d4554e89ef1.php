<div class="modal fade bd-example-modal-lg" id="famo-modal-add-testimonial" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-lgg conf">
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('admin.testimonial.store')); ?>" method="post" id="famo-form-add-testimonial">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH /home/dev61onlinetesti/public_html/famo_brand/resources/views/admin/inc/modal-add-testimonial.blade.php ENDPATH**/ ?>