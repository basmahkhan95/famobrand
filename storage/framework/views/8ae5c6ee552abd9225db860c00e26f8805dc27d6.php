<div class="main-menu menu-fixed menu-light menu-accordion" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item <?php echo e(Request::segment(2) === 'chat' ? 'active' : null); ?>"><a href="<?php echo e(route('admin.chat')); ?>"><i class="fa fa-comment-o" aria-hidden="true"></i><span
                        class="menu-title" data-i18n="">Chat</span></a></li>
        </ul>
    </div>
</div>
<?php /**PATH /home/dev61onlinetesti/public_html/famo_brand/resources/views/admin/inc/sidebar.blade.php ENDPATH**/ ?>