                                    ...
                                    <ul class="navbar-nav ml-auto">
                                        ...
                                        <li class="nav-item wow fadeInUp" data-wow-duration="1s"
                                            data-wow-delay="0.4s"><a href="<?php echo e(url('/logo-design')); ?>" class="nav-link">Logo
                                                Designs</a></li>
                                        <li class="nav-item wow fadeInUp" data-wow-duration="1s"
                                            data-wow-delay="0.6s"><a href="<?php echo e(url('/web-design-and-development')); ?>" class="nav-link">Web
                                                Design & Development</a></li>
                                        <!---->
                                        <li class="nav-item active wow fadeInUp" data-wow-duration="1s"
                                            data-wow-delay="0.8s"><a href="<?php echo e(url('/app-design-and-development')); ?>" class="nav-link">App
                                                Design & Development</a></li>
                                        <li class="nav-item wow fadeInUp" data-wow-duration="1s"
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-7 col-12 wow fadeInRight" data-wow-duration="1.5s" data-wow-delay="300ms">
                            <div class="inner-ban-right">
                                <img src="<?php echo e(asset('user/images/app-ban.png')); ?>" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="prof-sec">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 col-12">
                                    <img src="<?php echo e(asset('user/images/app-ban-2.png')); ?>" class="wow bounceIn"
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-12 align-self-center">
                    <div class="step-box center-box wow zoomIn" data-wow-duration="1s" data-wow-delay="0.3s">
                        <img src="<?php echo e(asset('user/images/and-ios.png')); ?>">
                    </div>
                </div>
                <div class="col-md-4 col-12">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 col-12 d-flex">
                    <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.3s">
                        <div class="work-img">
                            <img src="<?php echo e(asset('user/images/app-1.png')); ?>" class="hvr-icon">
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-12 d-flex">
                    <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.6s">
                        <div class="work-img">
                            <img src="<?php echo e(asset('user/images/app-2.png')); ?>" class="hvr-icon">
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 offset-md-0 offset-sm-3 col-12 d-flex">
                    <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.9s">
                        <div class="work-img">
                            <img src="<?php echo e(asset('user/images/app-3.png')); ?>" class="hvr-icon">
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-12 d-flex">
                    <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.3s">
                        <div class="work-img">
                            <img src="<?php echo e(asset('user/images/app-4.png')); ?>" class="hvr-icon">
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-12 d-flex">
                    <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.6s">
                        <div class="work-img">
                            <img src="<?php echo e(asset('user/images/app-5.png')); ?>" class="hvr-icon">
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 offset-md-0 offset-sm-3 col-12 d-flex">
                    <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.9s">
                        <div class="work-img">
                            <img src="<?php echo e(asset('user/images/app-6.png')); ?>" class="hvr-icon">
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', ['Title' => 'App Design And Development'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev61onlinetesti/public_html/famo_brand/resources/views/app-design-and-development.blade.php ENDPATH**/ ?>