                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-12 d-flex">
                        <div class="service-boxes-main hvr-icon-bob wow zoomIn" data-wow-duration="1.2s"
                            ...
                            <div class="service-img">
                                <img src="<?php echo e(asset('user/images/what-1.png')); ?>" class="hvr-icon">
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-12 d-flex">
                        <div class="service-boxes-main hvr-icon-bob wow zoomIn" data-wow-duration="1.2s"
                             data-wow-delay="0.6s">
                            <div class="service-img">
                                <img src="<?php echo e(asset('user/images/what-2.png')); ?>" class="hvr-icon">
                            </div>
                            <div class="service-text">
                                <h3>Web Design</h3>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-12 d-flex">
                        <div class="service-boxes-main hvr-icon-bob wow zoomIn" data-wow-duration="1.2s"
                             data-wow-delay="0.9s">
                            <div class="service-img">
                                <img src="<?php echo e(asset('user/images/what-3.png')); ?>" class="hvr-icon">
                            </div>
                            <div class="service-text">
                                <h3>App Design</h3>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-12 d-flex">
                        <div class="service-boxes-main hvr-icon-bob wow zoomIn" data-wow-duration="1.2s"
                             data-wow-delay="0.3s">
                            <div class="service-img">
                                <img src="<?php echo e(asset('user/images/what-4.png')); ?>" class="hvr-icon">
                            </div>
                            <div class="service-text">
                    ...
                    <div class="col-md-4 col-sm-6 col-12 d-flex">
                        <div class="service-boxes-main hvr-icon-bob wow zoomIn" data-wow-duration="1.2s"
                             data-wow-delay="0.6s">
                            <div class="service-img">
                                <img src="<?php echo e(asset('user/images/what-5.png')); ?>" class="hvr-icon">
                            </div>
                            <div class="service-text">
                    ...
                    <div class="col-md-4 col-sm-6 col-12 d-flex">
                        <div class="service-boxes-main hvr-icon-bob wow zoomIn" data-wow-duration="1.2s"
                             data-wow-delay="0.9s">
                            <div class="service-img">
                                <img src="<?php echo e(asset('user/images/what-6.png')); ?>" class="hvr-icon">
                            </div>
                            <div class="service-text">
                ...
                <div class="col-12">
                    <div class="footer footer-1">
                        <ul>
                            ...
                            <li class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="1.1s"><a href="<?php echo e(url('/')); ?>">Web: famobrands.com</a></li>
...
<?php echo $__env->make('layouts.app', ['Title' => 'About Us'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev61onlinetesti/public_html/famo_brand/resources/views/about-us.blade.php ENDPATH**/ ?>