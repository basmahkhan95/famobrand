            ...
            <div class="modal-body">
                <div class="payment-modal-main">
                    <div class="payment-modal-inner">
                        <form action="<?php echo e(route('payment.store')); ?>" method="post" id="famo-payment-form">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH /home/dev61onlinetesti/public_html/famo_brand/resources/views/inc/modal-payment.blade.php ENDPATH**/ ?>