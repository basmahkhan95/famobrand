<section class="testimonials why-choose">
    <div class="container">
        ...
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-6 col-12">
                <img src="<?php echo e(asset('user/images/why-choose.png')); ?>" class="wow zoomIn" data-wow-duration="1s"
                     data-wow-delay="0.4s">
            </div>
        </div>
    </div>
                ...
                <div class="col-xl-8 col-lg-8 col-md-6 d-flex align-items-center">
                    <div class="testi-slider wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="owl-carousel owl-theme" id="testi">
                            <?php $__currentLoopData = \App\Testimonial::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="item">
                                    <div class="box">
                                        <div class="media align-items-center">
                                            
                                            <div class="media-body right-content">
                                                <h5><?php echo e($key->client_name); ?></h5>
                                                <h6>Member</h6>
                                            </div>
                                        </div>
                                        <p><?php echo e($key->testimonial); ?></p>
                                        <img src="<?php echo e(asset('user/images/testi-coma.png')); ?>" alt="img">
                                    </div>
                                </div>
...
<?php /**PATH /home/dev61onlinetesti/public_html/famo_brand/resources/views/inc/testimonials.blade.php ENDPATH**/ ?>