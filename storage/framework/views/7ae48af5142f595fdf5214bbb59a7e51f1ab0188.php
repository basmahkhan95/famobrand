                                    ...
                                    <div class="card-body table-responsive card-dashboard">
                                            ...
                                            <div class="col-12 d-block d-sm-flex justify-content-between">
                                                <div class="left">
                                                    ...
                                                    <h1>Total Messages<span><i class="fa fa-envelope"
                                                                ...
                                                                class="circle"><?php echo e($Feedback->count()); ?></span></span>
                                                    </h1>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row maain-tabble mt-1">
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <tbody>
                                                <?php $__currentLoopData = $Feedback; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                            ...
                                                            <div class="btn-group mr-1 mb-1">
                                                                ...
                                                                <div class="dropdown-menu" x-placement="bottom-start"
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                       href="<?php echo e(route('admin.feedback.show',['id' => $value->id])); ?>"><i
                                                                            class="fa fa-eye"></i>View</a>
                                                                    <a class="dropdown-item famo-swal-delete" href="javascript:void(0)"
                                                                       data-route="<?php echo e(route('admin.feedback.delete', ['id' => $value->id])); ?>"><i
...
<?php echo $__env->make('admin.layouts.auth', ['Title' => 'Feedback Log'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev61onlinetesti/public_html/famo_brand/resources/views/admin/feedback/index.blade.php ENDPATH**/ ?>