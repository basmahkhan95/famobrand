        ...
        <div class="modal-content">
            ...
            <div class="payment-modal-main">
                <div class="payment-modal-inner  text-left">
                    <div class="row mt-3">
                        <div class="col-12">
                            <form action="<?php echo e(route('admin.testimonial.update')); ?>" method="post"
...
<?php /**PATH /home/dev61onlinetesti/public_html/famo_brand/resources/views/admin/inc/modal-edit-testimonial.blade.php ENDPATH**/ ?>