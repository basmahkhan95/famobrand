                        ...
                        <div class="col-lg-5 col-12">
                            ...
                            <div class="col-lg-7 col-12 wow fadeInRight" data-wow-duration="1.5s" data-wow-delay="300ms">
                                <div class="inner-ban-right">
                                    <img src="<?php echo e(asset('user/images/web-ban.png')); ?>" alt="img">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-12 d-flex">
                        <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.3s">
                            <div class="work-img">
                                <img src="<?php echo e(asset('user/images/web-1.png')); ?>" class="hvr-icon">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 d-flex">
                        <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.6s">
                            <div class="work-img">
                                <img src="<?php echo e(asset('user/images/web-2.png')); ?>" class="hvr-icon">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 d-flex">
                        <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.9s">
                            <div class="work-img">
                                <img src="<?php echo e(asset('user/images/web-3.png')); ?>" class="hvr-icon">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 d-flex">
                        <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.3s">
                            <div class="work-img">
                                <img src="<?php echo e(asset('user/images/web-4.png')); ?>" class="hvr-icon">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 d-flex">
                        <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.6s">
                            <div class="work-img">
                                <img src="<?php echo e(asset('user/images/web-5.png')); ?>" class="hvr-icon">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 d-flex">
                        <div class="work-box wow zoomIn" data-wow-duration="1.2s" data-wow-delay="0.9s">
                            <div class="work-img">
                                <img src="<?php echo e(asset('user/images/web-6.png')); ?>" class="hvr-icon">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-12 align-self-center">
                        <div class="step-box center-box wow zoomIn" data-wow-duration="1s" data-wow-delay="0.3s">
                            <img src="<?php echo e(asset('user/images/few-steps-img.png')); ?>">
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
...
<?php echo $__env->make('layouts.app', ['Title' => 'Web Design And Development'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev61onlinetesti/public_html/famo_brand/resources/views/web-design-and-development.blade.php ENDPATH**/ ?>