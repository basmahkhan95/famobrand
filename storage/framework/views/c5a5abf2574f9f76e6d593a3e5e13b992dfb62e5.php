                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="prof-img wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
                            <img src="<?php echo e(asset('user/images/print-1.png')); ?>" alt="img">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 col-12 pr-md-0">
                    <div class="sec2-left">
                        <img src="<?php echo e(asset('user/images/sec2-left.jpg')); ?>">
                    </div>
                </div>
                <div class="col-md-6 col-12 pl-md-0">
                    <div class="sec2-right">
                        <img src="<?php echo e(asset('user/images/sec2-right.jpg')); ?>">
                        <div class="text-box">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-12 pl-md-0">
                        <div class="prof-img wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
                            <img src="<?php echo e(asset('user/images/print-4.jpg')); ?>" alt="img">
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
...
<?php echo $__env->make('layouts.app', ['Title' => 'Printing And Accessories'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev61onlinetesti/public_html/famo_brand/resources/views/printing-and-accessories.blade.php ENDPATH**/ ?>